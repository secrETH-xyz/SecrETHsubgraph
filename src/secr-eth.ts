...
export function handleDecryptionCalled(event: DecryptionCalled): void {
  ...
  entity.cipher = event.params.cipher
  entity.shouldStoreDecryption = event.params.shouldStoreDecryption
  ...
  //
  // - contract.allCiphers(...)
  // - contract.blocksDelay(...)
  // - contract.getPubKey(...)
  // - contract.isSigner(...)
  // - contract.numSigners(...)
  // - contract.shareGenerationFractions(...)
  // - contract.threshold(...)
}
...
export function handleJoinNetworkRequest(event: JoinNetworkRequest): void {}
